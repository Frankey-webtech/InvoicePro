...
async function populateBusinessProfile(profile) {
    ...
    const profileData = {
        ...
        invoicePrefix: profile.get("invoicePrefix") || "INV-",

        estimatePrefix: profile.get("estimatePrefix") || "EST-"
    ...
    if (logo) {
        ...
        businessDOM.logoFileName.textContent = logo.name();
...
function handleLogoSelection(event) {
    ...
    businessDOM.logoFileName.textContent =
        file.name;
